<?php
    ...
    if(isset($_POST) && $_POST['tag']=='agregar'){
        ...
        $sql = "INSERT INTO libros VALUES(null,'$titulo','$autor','$tituloOriginal',$anioEdicion,'$lugarEdicion','$editorial',$paginas,$ubicacion,$volumen,'$numSerie',$carrera,'$url','$temaGeneral','$temaEspecifico')";
