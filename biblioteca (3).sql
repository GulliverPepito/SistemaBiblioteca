...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2018 a las 21:29:31
...
--
ALTER TABLE `prestamos_detalle`
  MODIFY `ID_Prestamo_Detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
